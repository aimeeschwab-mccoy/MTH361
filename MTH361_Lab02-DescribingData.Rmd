...
Describe the distribution of annual expenditures. For most consumers, is the amount of financial support provided by the DDS relatively high or low?
...
The variable `age` directly records a consumer's age; in the `age.cohort` variable, consumers are assigned to one of six age cohorts. Modify the previous code (repeated below) to make a plot of age. Describe the distribution of age in this sample of consumers. Do consumers tend to be older or younger?
...
Is there an equal representation of ethnic groups in this sample of consumers? Use the bar chart below to support your answer.
...
Does gender appear to be balanced in this sample of consumers? Modify the code below to make a bar chart to support your answer.
...
How do annual expenditures vary by age? Is there a large amount of variation in expenditures between age cohorts? Use the `age.cohort` variable as the measure of age.
...
__Disclaimer__: Throughout the lab worksheets, I'll be using a color palette called the Okabe-Ito color palette from the `colorblindr`. If you'd like to use this in your work, you can install the relevant R package at the link below.

https://rdrr.io/github/clauswilke/colorblindr/

If you don't want to use this, simply delete the last line and + sign.
...
How do annual expenditures vary by age? Is there a large amount of variation in expenditures between age cohorts? Use the `age` variable as the measure of age.
...
Which plot do you prefer - the faceted histograms (5) or the scatterplot (6)? What do you like/dislike about each plot?
